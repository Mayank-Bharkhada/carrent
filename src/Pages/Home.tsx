    ...
    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
      <View style={{ flex: 10.7, flexDirection: 'column' }}>
        ...
        <View style={{ flex: 1, flexDirection: 'row' }}>
          <View style={[styles.ViewDetailLeftForSecond]}>
            <Button
              icon={() =>
                <Icon
                  name="location-arrow"
      ...
      >
          ...
          <Icon
            name="circle-arrow-right" // Replace with your custom icon name
            size={35} // Adjust the icon size as needed
            color="#FFF"
            style={{ padding: 10, borderRadius: 100 }} // Adjust the icon color as needed
          />      
      </TouchableOpacity>
      ...
      <ScrollView
              ...
              <Button
                icon={() =>
                  <Icon
                    ...
                    size={11} // Adjust the icon size as needed
        ...
        <View style={styles.secondBlock}>
          ...
          <View style={styles.rightBlock}>
            <ImageBackground
              source={require('../Photos/HomeMap.png')}
        ...
        <View style={{ flex: 1, flexDirection: 'column', backgroundColor: '#2C2B34', borderRadius: 25, marginVertical: 15, paddingHorizontal: 20, paddingVertical: 10 }}>
